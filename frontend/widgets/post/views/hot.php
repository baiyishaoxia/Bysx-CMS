            ...
            <div class="row">
                <div class="col-lg-4 label-img-size">
                    <a href="#" class="post-label">
                        <img src="<?=($list['label_img']?\Yii::$app->params['upload_url'].$list['label_img']:\Yii::$app->params['default_rand_img'].rand(1,10).'.jpg')?>" alt="<?=$list['title']?>">
                    </a>
                </div>
                <div class="col-lg-8 btn-group">
                    ...
                    <span class="post-tags">
                        ...
                        <span class="glyphicon glyphicon-eye-open"></span><?=isset($list['browser'])?$list['browser']:0?>&nbsp;
